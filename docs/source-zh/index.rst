...
.. raw:: html
   ...
   <div class="rpent-hero">
     ...
     <p class="rpent-hero-subtitle">
       RPent (Recursive Physical Agent) 是一个用于构建具身智能体的开源框架，让智能体通过与物理世界的递归交互持续演进。它不预设某个具体的基础模型，而是把感知、推理、记忆、执行、自我演进这些异构能力统一到一个物理智能体中。凭借持续的交互、反思与适应，智能体能够获得超出其初始设计的新能力。
     </p>
   </div>
